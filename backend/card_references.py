...
REFERENCE_SEEDS: tuple[CardReferenceSeed, ...] = (
    ...
    CardReferenceSeed(
        ...
        ("Delta Gold Business", "Delta SkyMiles Gold Business"),
        ownership="Business",
        issuer_domain="americanexpress.com",
        issuer_url="https://www.americanexpress.com/us/credit-cards/business/business-credit-cards/delta-skymiles-gold-business-american-express-card/",
        reports_to_personal_credit=False,
    ),
    CardReferenceSeed(
        "American Express",
        ...
        issuer_domain="americanexpress.com",
        issuer_url="https://www.americanexpress.com/us/credit-cards/card/delta-skymiles-platinum-american-express-card/",
    ),
    CardReferenceSeed(
        "American Express",
        "Delta SkyMiles Platinum Business American Express Card",
        ("Delta Platinum Business", "Delta SkyMiles Platinum Business"),
        ownership="Business",
        issuer_domain="americanexpress.com",
        issuer_url="https://www.americanexpress.com/us/credit-cards/business/business-credit-cards/delta-skymiles-platinum-business-american-express-card/",
        reports_to_personal_credit=False,
    ),
    CardReferenceSeed(
        "American Express",
        ...
        issuer_domain="americanexpress.com",
        issuer_url="https://www.americanexpress.com/us/credit-cards/card/delta-skymiles-reserve-american-express-card/",
    ),
    CardReferenceSeed(
        "American Express",
        "Delta SkyMiles Reserve Business American Express Card",
        ("Delta Reserve Business", "Delta SkyMiles Reserve Business"),
        ownership="Business",
        issuer_domain="americanexpress.com",
        issuer_url="https://www.americanexpress.com/us/credit-cards/business/business-credit-cards/delta-skymiles-reserve-business-american-express-card/",
        reports_to_personal_credit=False,
    ),
    CardReferenceSeed(
        "American Express",
        "Delta SkyMiles Blue American Express Card",
        ("Delta Blue", "Delta SkyMiles Blue"),
        issuer_domain="americanexpress.com",
        issuer_url="https://www.americanexpress.com/us/credit-cards/card/delta-skymiles-blue-american-express-card/",
    ),
    CardReferenceSeed(
        "Chase",
